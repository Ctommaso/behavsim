...
def washing_machine(param, res_dir, text_view):
        ...
        for j in range(int(round(param["Number of Days"][0]))):
            ...
            if cycles != 0:
                ...
                for k in range(cycles):
                    ...
                    heat = sub.rd_var.norm(param["Number of Heatings"][0],
                    ...
                    for l in range(heat):
                        ...
                        l2 = l1+sub.rd_var.norm(param["Inter Heating Delay [min]"][0],
                    ...
                    l2 = l1+sub.rd_var.norm(param["Spinning Duration [min]"][0],
                                            param["Spinning Duration [min]"][1],
                                            True)
                    power = sub.rd_var.norm(param["Spinning Power [W]"][0], param["Spinning Power [W]"][1], False)
                    active_power[l1:l2] += power
                    l1 = l2
